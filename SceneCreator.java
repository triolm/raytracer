...
public class SceneCreator {
        ...
        public static Scene scene1(double xResolution, double yResolution) {
                ...
                Surface d1 = new Ring(Scene.blackHolePosition,
                                Scene.schild * 3, 0, new Vector(0, 1, .1),
                                new Lambert(new Color(1, 1, 1)));
                s.addSurface(d1);

                Light lt1 = new PointLight(new Color(1, 1, 1), new Point(0, 200000,
                                0));
                s.addLight(lt1);
                Light lt2 = new PointLight(new Color(1, 1, 1), new Point(0, -200000,
                                0));
                s.addLight(lt2);
                Light lt3 = new PointLight(new Color(1, 1, 1), new Point(0, 0,
